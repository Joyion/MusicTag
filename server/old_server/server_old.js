...
//routes 
const biCuesRoutes = require("./old_routes/api.bicues");
// const { resolveAny } = require("dns");
app.use("/api/bicues", biCuesRoutes);
const exportRoutes = require("./old_routes/api.export")
app.use("/api/export", exportRoutes);

const exportMusicMark = require('./old_routes/api.export.musicMark');
app.use('/api/musicMark', exportMusicMark);

const exportBmat = require('./old_routes/bmat.export')
app.use('/api/bmat', exportBmat);

const exportProtunes = require("./old_routes/api.export.protunes");
app.use('/api/protunes', exportProtunes);

const exportRussiaWarner = require("./old_routes/api.export.russiaWarner");
